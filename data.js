...
const siteContent = {
    'zh-TW': {
        ...
        portfolio: {
            ...
            visitLink: '前往連結',
            list: [
                { title: '匹克球 LINE 揪團神器', category: 'web', images: ['https://placehold.co/600x400/1f2937/f59e0b?text=Project'], desc: '一個為實體運動社群打造的專屬排程與管理工具，無縫整合 LINE 平台。', details: '<h3>專案目標</h3><p>解決實體運動社群在揪團、排程與統計上的痛點，提供一站式的 LINE 整合服務。</p><h3>技術亮點</h3><ul><li><b>前端與介面：</b> 使用 LINE LIFF 打造無縫整合的行動端體驗。</li><li><b>後端與資料庫：</b> 採用 Node.js 開發 API，並結合 Supabase 實現高效、即時的資料庫庫存取與管理。</li></ul>' },
                { title: 'OpenClaw 專屬 AI 助理', category: 'web', images: ['https://placehold.co/600x400/1f2937/f59e0b?text=Project'], desc: '基於 Telegram 的全能個人 AI 助理，能自動化處理生活與開發任務。', details: '<h3>專案目標</h3><p>打造一個高度客製化的私人助理，用於處理日常繁瑣任務、資訊檢索與專案管理。</p><h3>技術亮點</h3><ul><li><b>AI 核心整合：</b> 深度整合 Gemini CLI，具備強大的自然語言理解與生成能力。</li><li><b>安全授權：</b> 實作 OAuth 驗證機制，確保私人資料的安全性。</li><li><b>多功能模組：</b> 內建手遊測試封包分析輔助、加密貨幣最新資訊抓取，以及個人專案(如匹克球工具)的進度管理功能。</li></ul>' },
