...
const siteContent = {
    'zh-TW': {
        ...
        portfolio: {
            ...
            visitLink: '前往連結',
            list: [
                { title: '匹克球 LINE 揪團神器', category: 'web', images: ['data/images/pickleball-social.svg', 'data/images/pickleball-schedule.svg'], desc: '一個為實體運動社群打造的專屬排程與管理工具，無縫整合 LINE 平台。', details: '<h3>專案目標</h3><p>解決實體運動社群在揪團、排程與統計上的痛點，提供一站式的 LINE 整合服務。</p><h3>技術亮點</h3><ul><li><b>前端與介面：</b> 使用 LINE LIFF 打造無縫整合的行動端體驗。</li><li><b>後端與資料庫：</b> 採用 Node.js 開發 API，並結合 Supabase 實現高效、即時的資料庫庫存取與管理。</li></ul>' },
        ...
        journey: {
            title: '我的歷程',
            list: [
                { date: "2026 3月", title: "匹克球揪團系統開發", description: "為了優化在地社群體驗，採用 Node.js 與 Supabase 開發結合 LINE LIFF 的自動化排程工具。", icon: "fa-table-tennis", align: "right" },
    ...
    'en': {
        ...
        portfolio: {
            ...
            list: [
                { title: 'Pickleball LINE Meetup Tool', category: 'web', images: ['https://placehold.co/600x400/1f2937/f59e0b?text=Project'], desc: 'A dedicated scheduling and management tool built for physical sports communities, seamlessly integrated with the LINE app.', details: '<h3>Project Goal</h3><p>To solve the pain points of organizing, scheduling, and tracking attendance for local sports groups by providing an all-in-one LINE integrated service.</p><h3>Technical Highlights</h3><ul><li><b>Frontend & UI:</b> Built with LINE LIFF for a seamless mobile experience within the messaging app.</li><li><b>Backend & Database:</b> Developed robust APIs using Node.js, combined with Supabase for efficient, real-time database management.</li></ul>' },
                { title: 'OpenClaw Personal AI Assistant', category: 'web', images: ['https://placehold.co/600x400/1f2937/f59e0b?text=Project'], desc: 'A versatile personal AI assistant based on Telegram, automating daily life and development tasks.', details: '<h3>Project Goal</h3><p>To build a highly customized private assistant for handling tedious daily tasks, information retrieval, and project management.</p><h3>Technical Highlights</h3><ul><li><b>AI Core Integration:</b> Deeply integrated with Gemini CLI, featuring powerful natural language understanding and generation capabilities.</li><li><b>Secure Authorization:</b> Implemented OAuth mechanisms to ensure the security of private data.</li><li><b>Multi-function Modules:</b> Built-in modules for mobile game packet analysis assistance, cryptocurrency news scraping, and personal project (like the Pickleball tool) management.</li></ul>' },
