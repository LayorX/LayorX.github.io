...
const videosData = [
    {
        type: 'youtube',
        category: 'design', 
        src: 'IZLCpQZ1AC8', // YouTube Video ID
        title: 'The Storm of Ages – Epic Pirate Fantasy Trailer | Laugh Tale’s Call',
        description: '在大航海時代的中心地帶，有一位海盜鶴立雞群。艾瑞克「影手」維恩駕船駛入命運的風暴之中－駛向最後的島嶼：拉夫德爾。'
    },
    {
        type: 'youtube',
        category: 'design', 
        src: 'ZVRhgtBONg8', // YouTube Video ID
        title: '深山X古廟X和尚X書卷',
        description: '傳說深山裡有個廟，廟裡有個老和尚，老和尚手上有本書，書上說著傳說...'
    },
    {
        type: 'local',
        category: 'design', 
        src: 'data/videos/The Last Ballot.mp4', // 本地影片路徑
        title: '影預告:最後一投，每一票都是未來',
        description: '一個快速展示AI製作影片的能力'
    },
    {
        type: 'local',
        category: 'design', 
        src: 'data/videos/Eagle Flight.mp4', // 本地影片路徑
        title: '自由自在地飛翔',
        description: '一個快速展示AI製作影片的能力'
    }
];
...
const blogData = [
    { date: "2025年8月4日", title: "為什麼我選擇用 Vanilla JS 打造個人網站？", summary: "在充滿框架的時代，回歸基礎或許能帶來意想不到的收穫。本文分享我從零開始，不使用任何前端框架開發這個網站的心路歷程、技術抉擇與挑戰。", link: "#home" },
    { date: "2025年7月20日", title: "世界觀設定：如何為你的故事建立一個可信的宇宙", summary: "一個引人入勝的故事，背後往往有一個堅實的世界觀支撐。分享我在創作《夢境時差》時，如何設定規則、文化與衝突，讓虛構的世界感覺真實。", link: "#home" }
];
